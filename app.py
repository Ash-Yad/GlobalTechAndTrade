...
# ==========================================
# FIX FOR RENDER TEMPLATE ISSUE
# ==========================================
# We calculate the absolute path to the 'templates' folder.
# This ensures Flask can find your HTML files both locally and on Render.
template_dir = os.path.abspath('./templates')

# Initialize Flask app with the specific template folder
...
# Setup logging
if not app.debug:
    # NOTE: On Render, we cannot create a 'logs' folder because the file system is read-only.
    # We only log to the console so Render can capture it in their dashboard.
